...
def rename_images_in_subfolders(root_folder):
    for folder_path, subfolders, files in os.walk(root_folder):
        ...
        for index, image_file in enumerate(image_files, start=1):
            ...
            # Build new file name
            new_file_name = f"image_{index}{file_ext}"
            ...
            try:
                ...
                print(f"✅ Renamed '{image_file}' ➡️ '{new_file_name}' in folder '{subfolder_name}'")
            except Exception as e:
                print(f"❌ Error renaming '{image_file}': {e}")

# Example usage
root_folder = 'images'  # Replace with your actual root path
